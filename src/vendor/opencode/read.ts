  ...
  Effect.gen(function* () {
    ...
    const run = Effect.fn("ReadTool.execute")(function* (
      ...
      if (isImage || isPdfAttachment(mime)) {
        if (Number(stat.size) > 5 * 1024 * 1024) throw new Error("Attachment exceeds the 5 MiB limit")
